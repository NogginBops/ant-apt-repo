...
package com.codemarvels.ant.aptrepotask.signing;
...
public class PGPSigner {
	 ...
	 * @throws PGPException
	 */
	public PGPSigner(InputStream keyring, String keyId, String passphrase, int digest)
		...
		privateKey = secretKey.extractPrivateKey(new BcPBESecretKeyDecryptorBuilder(new BcPGPDigestCalculatorProvider())
	 ...
	 * @throws GeneralSecurityException
	 */
	public void clearSignDetached(String input, OutputStream output)
			throws IOException, PGPException, GeneralSecurityException {
